...
contract WARTOKEN is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("War", "WAR") {
        ...
        marketingWallet = address(0xb70c10c1F971A99e747C107Ca58cD43FF16632a1); // set as marketing wallet
        devWallet = address(0xb70c10c1F971A99e747C107Ca58cD43FF16632a1); // set as dev wallet
